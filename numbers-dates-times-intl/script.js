...
const account1 = {
  ...
  movementsDates: [
    ...
    '2021-09-22T23:36:17.929Z',
    '2021-09-26T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
console.log(Math.max(7, 19, 42, 31, 6));
console.log(Math.max(7, 19, '42', 31, 6));
console.log(Math.max(7, 19, '42X', 31, 6));

console.log(Math.min(7, 19, 42, 31, 6));
...
console.log(new Date('Oct 26 2021 12:29:03'));
console.log(new Date('January 14, 2022'));
console.log(new Date(account1.movementsDates[0]));

console.log(new Date(2035, 5, 15, 19, 23, 45));
...
//working with dates
const future = new Date(2035, 5, 15, 19, 23);
console.log(future);
...
console.log(new Date(2065540980000));
...
const days1 = daysPassed(new Date(2035, 5, 15), new Date(2035, 5, 25));
console.log(days1);*/

const num = 54455425.78;
